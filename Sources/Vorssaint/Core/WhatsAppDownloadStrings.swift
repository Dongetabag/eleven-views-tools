...
extension WhatsAppDownloadStrings {
    static let enUS = WhatsAppDownloadStrings(
        ...
        accessDenied: "Eleven Views Tools cannot access Downloads. Allow it in Files & Folders.",
        ...
        localNote: "Only local file metadata is inspected. Eleven Views Tools never reads chats or file contents.",
    ...
    static let es = WhatsAppDownloadStrings(
        ...
        accessDenied: "Eleven Views Tools no puede acceder a Descargas. Permite el acceso en Archivos y carpetas.",
        ...
        localNote: "Solo se consultan metadatos locales. Eleven Views Tools nunca lee los chats ni el contenido de los archivos.",
    ...
    static let ptBR = WhatsAppDownloadStrings(
        ...
        accessDenied: "O Eleven Views Tools não pode acessar Downloads. Permita em Arquivos e Pastas.",
        ...
        localNote: "Apenas metadados locais são consultados. O Eleven Views Tools nunca lê conversas nem o conteúdo dos arquivos.",
    ...
    static let de = translated(language: .de,
        ...
        accessDenied: "Eleven Views Tools kann nicht auf Downloads zugreifen. Erlaube den Zugriff unter Dateien & Ordner.",
    ...
    static let fr = translated(language: .fr,
        ...
        accessDenied: "Eleven Views Tools ne peut pas accéder à Téléchargements. Autorisez-le dans Fichiers et dossiers.",
    ...
    static let it = translated(language: .it,
        ...
        accessDenied: "Eleven Views Tools non può accedere a Download. Consenti l'accesso in File e cartelle.",
    ...
    static let tr = translated(language: .tr,
        ...
        accessDenied: "Eleven Views Tools İndirilenler'e erişemiyor. Dosyalar ve Klasörler'den izin verin.",
    ...
    static let ru = translated(language: .ru,
        ...
        accessDenied: "Eleven Views Tools не может открыть Загрузки. Разрешите доступ в разделе «Файлы и папки».",
    ...
    static let zhHans = translated(language: .zhHans,
        ...
        accessDenied: "Eleven Views Tools 无法访问下载文件夹。请在“文件与文件夹”中允许访问。",
    ...
    static let zhTW = translated(language: .zhTW,
        ...
        accessDenied: "Eleven Views Tools 無法取用下載項目。請在「檔案與資料夾」允許取用。",
    ...
    private static func operational(_ language: AppLanguage) -> OperationalStrings {
        ...
        case .de:
            return OperationalStrings(
                ...
                localNote: "Nur lokale Metadaten werden geprüft. Eleven Views Tools liest weder Chats noch Dateiinhalte.",
        ...
        case .fr:
            return OperationalStrings(
                ...
                localNote: "Seules les métadonnées locales sont consultées. Eleven Views Tools ne lit ni les discussions ni le contenu des fichiers.",
        ...
        case .it:
            return OperationalStrings(
                ...
                localNote: "Vengono controllati solo metadati locali. Eleven Views Tools non legge chat o contenuti dei file.",
        ...
        case .tr:
            return OperationalStrings(
                ...
                localNote: "Yalnızca yerel meta veriler incelenir. Eleven Views Tools sohbetleri veya dosya içeriklerini okumaz.",
        ...
        case .ru:
            return OperationalStrings(
                ...
                localNote: "Проверяются только локальные метаданные. Eleven Views Tools не читает чаты и содержимое файлов.",
        ...
        case .zhHans:
            return OperationalStrings(
                ...
                localNote: "只检查本地元数据。Eleven Views Tools 绝不读取聊天或文件内容。",
        ...
        case .zhTW, .zhHK:
            return OperationalStrings(
                ...
                localNote: "只檢查本機中繼資料。Eleven Views Tools 絕不讀取對話或檔案內容。",
