...
extension PermissionGuideStrings {
    static let ko = PermissionGuideStrings(
        ...
        stepToggle: "그 목록에서 Eleven Views Tools를 켜세요.",
...
extension PermissionGuideStrings {
    static let enUS = PermissionGuideStrings(
        ...
        stepToggle: "Turn Eleven Views Tools on in that list.",
    ...
    static let ptBR = PermissionGuideStrings(
        ...
        stepToggle: "Ligue o Eleven Views Tools nessa lista.",
    ...
    static let tr = PermissionGuideStrings(
        ...
        stepToggle: "O listede Eleven Views Tools'i açın.",
    ...
    static let ru = PermissionGuideStrings(
        ...
        stepToggle: "Включите Eleven Views Tools в этом списке.",
    ...
    static let es = PermissionGuideStrings(
        ...
        stepToggle: "Activa Eleven Views Tools en esa lista.",
    ...
    static let de = PermissionGuideStrings(
        ...
        stepToggle: "Schalte Eleven Views Tools in dieser Liste ein.",
    ...
    static let fr = PermissionGuideStrings(
        ...
        stepToggle: "Activez Eleven Views Tools dans cette liste.",
    ...
    static let it = PermissionGuideStrings(
        ...
        stepToggle: "Attiva Eleven Views Tools in quell'elenco.",
    ...
    static let ja = PermissionGuideStrings(
        ...
        stepToggle: "そのリストでEleven Views Toolsをオンにしてください。",
    ...
    static let zhHans = PermissionGuideStrings(
        ...
        stepToggle: "在列表中开启 Eleven Views Tools。",
    ...
    static let zhTW = PermissionGuideStrings(
        ...
        stepToggle: "在清單中開啟 Eleven Views Tools。",
