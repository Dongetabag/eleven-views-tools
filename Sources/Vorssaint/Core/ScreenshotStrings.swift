...
extension ScreenshotFeatureStrings {
    static let enUS = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Eleven Views Tools sends only the rendered image and the expiration you choose. It does not send your name, account, device identifier or MAC address. On this Mac, it keeps only the link, expiration and private deletion token while the link is active.",
        ...
        hideVorssaintWindowsToggle: "Hide Eleven Views Tools windows",
    ...
    static let ptBR = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "O Eleven Views Tools envia somente a imagem renderizada e o prazo que você escolher. Ele não envia seu nome, conta, identificador do aparelho nem endereço MAC. Neste Mac, guarda apenas o link, o prazo e o token privado de exclusão enquanto o link estiver ativo.",
        ...
        hideVorssaintWindowsToggle: "Ocultar janelas do Eleven Views Tools",
    ...
    static let tr = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Eleven Views Tools yalnızca işlenmiş görüntüyü ve seçtiğiniz süreyi gönderir. Adınızı, hesabınızı, aygıt tanımlayıcınızı veya MAC adresinizi göndermez. Bu Mac'te bağlantı etkinken yalnızca bağlantı, sona erme zamanı ve özel silme anahtarı saklanır.",
        ...
        hideVorssaintWindowsToggle: "Eleven Views Tools pencerelerini gizle",
    ...
    static let ru = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Eleven Views Tools отправляет только готовое изображение и выбранный срок действия. Он не отправляет ваше имя, учётную запись, идентификатор устройства или MAC-адрес. На этом Mac сохраняются только ссылка, срок действия и закрытый токен удаления, пока ссылка активна.",
        ...
        hideVorssaintWindowsToggle: "Скрывать окна Eleven Views Tools",
    ...
    static let es = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Eleven Views Tools solo envía la imagen procesada y el plazo que elijas. No envía tu nombre, cuenta, identificador del dispositivo ni dirección MAC. En este Mac solo guarda el enlace, el vencimiento y el token privado de eliminación mientras el enlace está activo.",
        ...
        hideVorssaintWindowsToggle: "Ocultar ventanas de Eleven Views Tools",
    ...
    static let de = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Eleven Views Tools sendet nur das fertige Bild und die gewählte Ablaufzeit. Name, Konto, Gerätekennung und MAC-Adresse werden nicht gesendet. Auf diesem Mac bleiben nur der Link, die Ablaufzeit und das private Löschtoken gespeichert, solange der Link aktiv ist.",
        ...
        hideVorssaintWindowsToggle: "Eleven Views Tools-Fenster ausblenden",
    ...
    static let fr = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Eleven Views Tools envoie uniquement l’image finale et la durée choisie. Il n’envoie ni votre nom, ni votre compte, ni l’identifiant de l’appareil, ni l’adresse MAC. Sur ce Mac, seuls le lien, son expiration et le jeton privé de suppression sont conservés tant que le lien est actif.",
        ...
        hideVorssaintWindowsToggle: "Masquer les fenêtres Eleven Views Tools",
    ...
    static let it = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Eleven Views Tools invia solo l’immagine elaborata e la scadenza scelta. Non invia nome, account, identificatore del dispositivo o indirizzo MAC. Su questo Mac conserva solo il link, la scadenza e il token privato di eliminazione mentre il link è attivo.",
        ...
        hideVorssaintWindowsToggle: "Nascondi le finestre di Eleven Views Tools",
    ...
    static let ja = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Eleven Views Tools が送信するのは、書き出した画像と選択した有効期限だけです。氏名、アカウント、デバイス識別子、MACアドレスは送信しません。このMacには、リンクが有効な間だけリンク、有効期限、非公開の削除トークンが保存されます。",
        ...
        hideVorssaintWindowsToggle: "Eleven Views Toolsのウインドウを隠す",
    ...
    static let ko = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Eleven Views Tools은 완성된 이미지와 선택한 만료 시간만 전송합니다. 이름, 계정, 기기 식별자 또는 MAC 주소는 전송하지 않습니다. 이 Mac에는 링크가 활성화된 동안 링크, 만료 시간 및 비공개 삭제 토큰만 보관됩니다.",
        ...
        hideVorssaintWindowsToggle: "Eleven Views Tools 윈도우 가리기",
    ...
    static let zhHans = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Eleven Views Tools 只会发送处理后的图片和你选择的有效期，不会发送姓名、账户、设备标识符或 MAC 地址。链接有效期间，这台 Mac 只保存链接、到期时间和私密删除令牌。",
        ...
        hideVorssaintWindowsToggle: "隐藏 Eleven Views Tools 窗口",
    ...
    static let zhTW = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Eleven Views Tools 只會傳送處理後的圖片和你選擇的有效期限，不會傳送姓名、帳號、裝置識別碼或 MAC 位址。連結有效期間，這台 Mac 只會保存連結、到期時間和私人刪除權杖。",
        ...
        previewPositionBottomLeft: "左下角",
        previewPositionBottomRight: "右下角",
        hideVorssaintWindowsToggle: "隱藏 Eleven Views Tools 視窗",
    ...
    static let zhHK = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Eleven Views Tools 只會傳送處理後的圖片同你揀選嘅有效期限，唔會傳送姓名、帳戶、裝置識別碼或 MAC 位址。連結有效期間，呢部 Mac 只會保存連結、到期時間同私人刪除權杖。",
