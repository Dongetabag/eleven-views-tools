...
extension KillProcessFeatureStrings {
    static let enUS = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Eleven Views Tools needs administrator access to end “%@”."
    )
    ...
    static let ptBR = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "O Eleven Views Tools precisa de acesso de administrador para encerrar “%@”."
    )
    ...
    static let tr = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Eleven Views Tools’in “%@” işlemini sonlandırması için yönetici erişimi gerekiyor."
    )
    ...
    static let ru = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Eleven Views Tools нужны права администратора, чтобы завершить «%@»."
    )
    ...
    static let es = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Eleven Views Tools necesita acceso de administrador para finalizar “%@”."
    )
    ...
    static let de = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Eleven Views Tools benötigt Administratorrechte, um „%@“ zu beenden."
    )
    ...
    static let fr = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Eleven Views Tools a besoin d'un accès administrateur pour arrêter « %@ »."
    )
    ...
    static let it = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Eleven Views Tools richiede l'accesso da amministratore per terminare “%@”."
    )
    ...
    static let zhHans = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Eleven Views Tools 需要管理员权限才能结束“%@”。"
    )
    ...
    static let zhTW = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Eleven Views Tools 需要管理員權限才能結束「%@」。"
    )
