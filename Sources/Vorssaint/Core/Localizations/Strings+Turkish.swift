...
extension Strings {
    static let tr = Strings(
        statusIdleTooltip: "Eleven Views Tools: normal uyku",
        statusActiveUntil: "Eleven Views Tools: şu zamana kadar uyanık",
        statusActiveIndefinite: "Eleven Views Tools: süresiz uyanık",
        ...
        menuAbout: "Eleven Views Tools Hakkında",
        menuQuit: "Eleven Views Tools'ten Çık",
        menuHide: "Eleven Views Tools'i Gizle",
        ...
        notifyBatteryTitle: "Eleven Views Tools devre dışı",
        notifyBatteryBody: "Pil düşük. Şarjı korumak için normal uyku geri yüklendi.",
        adminPromptClamshellOn: "Eleven Views Tools'in, Mac'i kapak kapalıyken çalıştırmak için parolana ihtiyacı var.",
        adminPromptClamshellOff: "Eleven Views Tools'in, Mac'in normal uykusunu geri yüklemek için parolana ihtiyacı var.",
        adminPromptRecover: "Mac'in uykusu kapalıyken Eleven Views Tools kapandı. Normal uykuyu geri yüklemek için parolayı gir.",
        adminPromptUpdate: "Eleven Views Tools güncellemeyi yüklemek için parolanıza ihtiyaç duyuyor.",
        adminPromptSudoersInstall: "Eleven Views Tools, parola sormadan kapak kapalı modunu açıp kapatmak için kısıtlı bir kural oluşturacak (yalnızca pmset disablesleep). Parolanın gerektiği tek zaman bu.",
        adminPromptSudoersRemove: "Eleven Views Tools, parolasız kapak kapalı kuralını kaldıracak.",

        settingsTitle: "Eleven Views Tools Ayarları",
        tabGeneral: "Genel",
        tabEnergy: "Enerji",
        ...
        advancedResetDescription: "Eleven Views Tools'e verdiğin tüm izinleri (Erişilebilirlik, Ekran Kaydı, Tam Disk Erişimi ve diğerleri), oturum açma öğesini ve kapak kapalı kuralını kaldırır. Sıfırdan başlamak veya kaldırmadan önce temizlemek için kullanışlıdır. Uygulama yüklü kalır.",
        ...
        advancedUninstallDescription: "Yukarıdakilerin hepsini yapar, ardından tercihleri kaldırır ve Eleven Views Tools'i Çöp Sepeti'ne taşır; geride hiçbir şey bırakmaz. İş bitince uygulama kapanır. İstediğin zaman yeniden yükleyebilirsin.",
        advancedUninstallButton: "Eleven Views Tools'i tamamen kaldır",
        advancedUninstallConfirmTitle: "Eleven Views Tools kaldırılsın mı?",
        advancedUninstallConfirmBody: "Eleven Views Tools izinlerini temizleyecek, tercihlerini kaldıracak ve Çöp Sepeti'ne taşınıp kapanacak. Bu işlem uygulama içinden geri alınamaz, ama Çöp Sepeti'ni boşaltana kadar orada kalır.",
        ...
        keepAwakeAutoStart: "Eleven Views Tools açılınca uyanık tut",
        ...
        switcherEnable: "Eleven Views Tools değiştiricisini kullan",
        ...
        uninstallerFDAHint: "Listede Eleven Views Tools'i aç. Orada yoksa + düğmesine tıkla ve Uygulamalar'dan Eleven Views Tools'i seç. Erişim yalnızca uygulamayı yeniden açtıktan sonra geçerli olur.",
        ...
        homebrewMissingBody: "Eleven Views Tools, resmi Homebrew yükleyicisiyle Terminal'i açabilir. Terminal adımları gösterir ve gerekirse parolanı ister.",
        ...
        homebrewShellSetupBody: "Homebrew yüklü, ancak Terminal brew komutunu henüz bulamayabilir. Eleven Views Tools, kurulum komutuyla Terminal'i açabilir.",
        ...
        homebrewTerminalFallback: "Bu işlem, yönetici parolasını istemek için Terminal'e ihtiyaç duyar. Eleven Views Tools parolaları yakalamaz.",
        ...
        updateNotifyTitle: "Eleven Views Tools güncellemesi",
        ...
        updateNeedsApplicationsTitle: "Eleven Views Tools’i Uygulamalar klasörüne taşıyın",
        updateNeedsApplicationsBody: "Uygulama, disk görüntüsü veya geçici bir sistem konumu gibi güncellenemeyen bir yerden çalışıyor. Eleven Views Tools’i Uygulamalar klasörüne sürükleyin, oradan açın ve yeniden deneyin.",
        ...
        obStart: "Eleven Views Tools'i aç",
        obStepWelcomeTitle: "Eleven Views Tools'e hoş geldin",
        ...
        obStepDoneBody: "Eleven Views Tools Mac'inle ilgilenmeye başladı bile.",
        ...
        obLanguageUpdateBody: "Eleven Views Tools artık birçok dil konuşuyor. Kullanmak istediğin dili seç; bunu istediğin zaman Ayarlar'dan değiştirebilirsin.",
        ...
        cleaningNeedsAxBody: "Klavyeyi güvenle kilitlemek için Eleven Views Tools'in Erişilebilirlik iznine ihtiyacı var. Sistem Ayarları'ndan izin ver ve tekrar dene.",
        ...
        donateHeading: "Eleven Views Tools'in gelişmesine destek ol",
        donateMessage: "Eleven Views Tools ücretsiz, bağımsız ve boş zamanlarımda geliştiriliyor. Maddi destek olmak istersen Buy Me a Coffee, geliştirmeyi sürdürmeme doğrudan yardımcı olur.",
        donateButton: "Buy Me a Coffee ile destek ol",
        donateThanks: "Burada olduğun için teşekkürler. 🖤",
        supportIntroTitle: "Eleven Views Tools'in gelişmesine destek ol",
        supportIntroMessage: "Geliştirmeye maddi destek olmak istersen bunu yapabileceğin tek yer Buy Me a Coffee.",
        supportIntroStarButton: "GitHub'da Eleven Views Tools'e yıldız ver",
        supportIntroStarMessage: "Maddi destek asla beklenmez. GitHub'da verilen bir yıldız, daha fazla kişinin Eleven Views Tools'i keşfetmesine yardımcı olur ve geliştirilmesinde gerçek bir fark yaratır.",
        supportIntroCoffeeButton: "Buy Me a Coffee ile destek ol",
        supportIntroLaterButton: "Şimdi değil",
        supportIntroDoneButton: "Tamam",
        discordIntroTitle: "Eleven Views Tools Discord topluluğu daha yeni başlıyor",
        discordIntroMessage: "Eleven Views Tools topluluğu yeni ve hâlâ şekilleniyor. Diğer kullanıcılarla tanışmak ve uygulamanın etrafında sıcak bir alan oluşturmaya yardım etmek için erkenden katıl.",
        ...
        communityIntroFollowButton: "X'te Eleven Views'i takip et",
        homebrewOfficialIntroTitle: "Artık resmî Homebrew kataloğunda",
        homebrewOfficialIntroMessage: "Eleven Views Tools artık doğrudan resmî Homebrew kataloğundan kurulabilir.",
        ...
        showMenuBarIconCaption: "Eleven Views Tools simgesi kaybolursa (macOS, çubukta yer kalmadığında menü çubuğu simgelerini gizleyebilir; çentikli Mac'lerde yaygındır), Eleven Views Tools'i Uygulamalar'dan veya Spotlight'tan yeniden aç: bu simgeyi yeniden oluşturur ve hâlâ gizliyse bu pencereyi açar. Buraya zaten ulaşabiliyorsan yukarıdaki düğme de aynısını yapar. Menü çubuğunda daha az simge veya daha az Eleven Views Tools metriği tutmak bunu çok daha az olası kılar.",
        ...
        menuBarIconManagerHintFormat: "%@ açık ve simgeyi gizli bölümünde tutuyor olabilir. Eleven Views Tools’i orada arayın veya %@ uygulamasını Eleven Views Tools’i her zaman gösterecek şekilde ayarlayın.",
        ...
        cleanerNotifDenied: "Eleven Views Tools bildirimleri sistemde kapalı.",
        cleanerNotifOpenSettings: "Bildirim ayarlarını aç…",
        launchAtLoginNeedsApplications: "Uygulama, oturum açılırken açılmaya izin vermeyen bir konumdan çalışıyor. Eleven Views Tools'i Uygulamalar klasörüne sürükleyin, oradan açın ve bu seçeneği yeniden açın.",
