...
extension Strings {
    static let ja = Strings(
        statusIdleTooltip: "Eleven Views Tools：通常のスリープ",
        statusActiveUntil: "Eleven Views Tools：次の時刻までスリープしない",
        statusActiveIndefinite: "Eleven Views Tools：解除するまでスリープしない",
        menuEnableAwake: "スリープ防止をオン",
        menuDisableAwake: "スリープ防止をオフ",
        menuActivateFor: "時間を指定してオン…",
        menuSettings: "設定…",
        menuAbout: "Eleven Views Tools について",
        menuQuit: "Eleven Views Tools を終了",
        menuHide: "Eleven Views Tools を隠す",
        ...
        notifyBatteryTitle: "Eleven Views Tools をオフにしました",
        notifyBatteryBody: "バッテリー残量が少なくなりました。充電を保護するため通常のスリープに戻しました。",
        adminPromptClamshellOn: "ふたを閉じても続けるには、Eleven Views Tools にパスワードが必要です。",
        adminPromptClamshellOff: "Mac の通常のスリープを元に戻すにはパスワードが必要です。",
        adminPromptRecover: "Mac のスリープを無効化したまま Eleven Views Tools が終了しました。通常のスリープに戻すにはパスワードを入力してください。",
        adminPromptUpdate: "アップデートをインストールするには Eleven Views Tools にパスワードが必要です。",
        adminPromptSudoersInstall: "ふたを閉じたモードをパスワードなしで切り替えられるよう、Eleven Views Tools が制限付きルール（pmset disablesleep のみ）を作成します。パスワードが必要なのはこの一度きりです。",
        adminPromptSudoersRemove: "パスワード不要のふたを閉じたモードのルールを Eleven Views Tools が削除します。",

        settingsTitle: "Eleven Views Tools 設定",
        tabGeneral: "一般",
        tabEnergy: "省エネルギー",
        ...
        advancedResetDescription: "Eleven Views Tools に許可したすべてのアクセス権（アクセシビリティ、画面収録、フルディスクアクセスなど）、ログイン項目、ふたを閉じたモードのルールを削除します。最初からやり直すときや、アンインストールの前に便利です。アプリはインストールされたまま残ります。",
        ...
        advancedUninstallDescription: "上記をすべて実行したうえで、環境設定を削除し、Eleven Views Tools をゴミ箱に移動して、何も残しません。完了後にアプリは終了します。いつでも再インストールできます。",
        advancedUninstallButton: "Eleven Views Tools を完全にアンインストール",
        advancedUninstallConfirmTitle: "Eleven Views Tools をアンインストールしますか？",
        advancedUninstallConfirmBody: "Eleven Views Tools はアクセス権を消去し、環境設定を削除し、ゴミ箱に移動してから終了します。この操作はアプリからは取り消せませんが、ゴミ箱を空にするまではゴミ箱に残ります。",
        ...
        keepAwakeAutoStart: "Eleven Views Tools起動時にスリープを防ぐ",
        ...
        switcherEnable: "Eleven Views Tools のスイッチャーを使う",
        ...
        uninstallerFDAHint: "リストで Eleven Views Tools をオンにします。表示されない場合は + をクリックし、アプリケーションから Eleven Views Tools を選びます。アクセス権はアプリを再度開いた後に有効になります。",
        ...
        homebrewMissingBody: "Eleven Views Tools は公式 Homebrew インストーラを Terminal で開けます。Terminal に手順が表示され、必要ならパスワードを求められます。",
        ...
        homebrewShellSetupBody: "Homebrew はインストールされていますが、Terminal がまだ brew コマンドを見つけられない場合があります。Eleven Views Tools は設定コマンドを Terminal で開けます。",
        ...
        homebrewTerminalFallback: "この操作では管理者パスワードを求めるために Terminal が必要です。Eleven Views Tools はパスワードを取得しません。",
        ...
        updateNotifyTitle: "Eleven Views Tools のアップデート",
        updateInstallFailedBody: "アップデートはダウンロードされましたが、適用できませんでした。GitHub のリリースページから最新版をダウンロードし、現在のアプリの上にドラッグして置き換えてください。",
        updateNeedsApplicationsTitle: "Eleven Views Tools を「アプリケーション」に移動してください",
        updateNeedsApplicationsBody: "アプリが、ディスクイメージやシステムの一時的な場所など、アップデートできない場所から実行されています。Eleven Views Tools を「アプリケーション」フォルダにドラッグし、そこから開いてからもう一度お試しください。",
        ...
        obStart: "Eleven Views Tools を開く",
        obStepWelcomeTitle: "Eleven Views Tools へようこそ",
        ...
        obStepDoneBody: "Eleven Views Tools はすでにあなたの Mac を見守っています。",
        ...
        obLanguageUpdateBody: "Eleven Views Tools が複数の言語に対応しました。使いたい言語を選んでください。設定でいつでも変更できます。",
        ...
        cleaningNeedsAxBody: "キーボードを安全にロックするには、Eleven Views Tools にアクセシビリティのアクセス権が必要です。システム設定で許可して、もう一度お試しください。",
        ...
        donateHeading: "Eleven Views Tools の成長を支える",
        donateMessage: "Eleven Views Tools は無料で独立したアプリとして、わたしの空き時間に開発しています。金銭的に支援したい場合は、Buy Me a Coffee が開発の継続に直接役立ちます。",
        donateButton: "Buy Me a Coffee で支援する",
        donateThanks: "来てくれてありがとう。🖤",
        supportIntroTitle: "Eleven Views Tools の成長を支える",
        supportIntroMessage: "開発を金銭的に支援したい場合は、Buy Me a Coffee が唯一の窓口です。",
        supportIntroStarButton: "GitHub で Eleven Views Tools にスターを付ける",
        supportIntroStarMessage: "金銭的な支援は決して必要ではありません。GitHub のスターは、より多くの人が Eleven Views Tools を見つける助けになり、開発にも大きな力になります。",
        supportIntroCoffeeButton: "Buy Me a Coffee で支援する",
        supportIntroLaterButton: "今はしない",
        supportIntroDoneButton: "完了",
        discordIntroTitle: "Eleven Views ToolsのDiscordコミュニティが始まります",
        discordIntroMessage: "Eleven Views Tools コミュニティは新しく、まだ成長の途中です。早い段階から参加して他のユーザーと出会い、アプリを囲む心地よい場所を一緒につくりましょう。",
        ...
        communityIntroFollowButton: "XでEleven Viewsをフォロー",
        homebrewOfficialIntroTitle: "Homebrew 公式カタログに登場",
        homebrewOfficialIntroMessage: "Eleven Views Tools を Homebrew 公式カタログから直接インストールできるようになりました。",
        ...
        showMenuBarIconCaption: "Eleven Views Tools のアイコンが消えた場合（メニューバーに空きがなくなると macOS がアイコンを隠すことがあり、ノッチのある Mac でよく起こります）、アプリケーションまたは Spotlight から Eleven Views Tools を開き直してください。アイコンが再作成され、それでも隠れている場合はこのウインドウが開きます。ここまでたどり着けるなら、上のボタンでも同じことができます。メニューバーのアイコンを減らすか、Eleven Views Tools の計測値を減らすと、起こりにくくなります。",
        ...
        menuBarIconManagerHintFormat: "%@ が起動中で、アイコンを隠しセクションにしまっている可能性があります。そこで Eleven Views Tools を探すか、%@ で Eleven Views Tools を常に表示する設定にしてください。",
        ...
        cleanerNotifDenied: "Eleven Views Tools の通知がシステムでオフになっています。",
        cleanerNotifOpenSettings: "通知設定を開く…",
        launchAtLoginNeedsApplications: "ログイン時に開けない場所からアプリが実行されています。Eleven Views Toolsをアプリケーションフォルダにドラッグし、そこから開いてもう一度オンにしてください。",
