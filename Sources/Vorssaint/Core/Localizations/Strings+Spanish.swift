...
extension Strings {
    static let es = Strings(
        statusIdleTooltip: "Eleven Views Tools: reposo normal",
        statusActiveUntil: "Eleven Views Tools: activo hasta",
        statusActiveIndefinite: "Eleven Views Tools: activo indefinidamente",
        menuEnableAwake: "Activar mantener activo",
        menuDisableAwake: "Desactivar mantener activo",
        menuActivateFor: "Activar durante…",
        menuSettings: "Ajustes…",
        menuAbout: "Acerca de Eleven Views Tools",
        menuQuit: "Salir de Eleven Views Tools",
        menuHide: "Ocultar Eleven Views Tools",
        ...
        notifyBatteryTitle: "Eleven Views Tools desactivado",
        notifyBatteryBody: "Batería baja. Se restauró el reposo normal para proteger la carga.",
        adminPromptClamshellOn: "Eleven Views Tools necesita tu contraseña para seguir con la tapa cerrada.",
        adminPromptClamshellOff: "Eleven Views Tools necesita tu contraseña para restaurar el reposo normal del Mac.",
        adminPromptRecover: "Eleven Views Tools se cerró mientras el reposo del Mac estaba desactivado. Introduce la contraseña para restaurar el reposo normal.",
        adminPromptUpdate: "Eleven Views Tools necesita tu contraseña para instalar la actualización.",
        adminPromptSudoersInstall: "Eleven Views Tools creará una regla restringida (solo pmset disablesleep) para alternar el modo de tapa cerrada sin pedir contraseña. Esta es la única vez que se necesita la contraseña.",
        adminPromptSudoersRemove: "Eleven Views Tools eliminará la regla de tapa cerrada sin contraseña.",

        settingsTitle: "Ajustes de Eleven Views Tools",
        tabGeneral: "General",
        tabEnergy: "Energía",
        ...
        advancedResetDescription: "Elimina todos los permisos que concediste a Eleven Views Tools (Accesibilidad, Grabación de pantalla, Acceso total al disco y otros), el ítem de inicio de sesión y la regla de tapa cerrada. Útil para empezar de cero o antes de desinstalar. La app sigue instalada.",
        ...
        advancedUninstallDescription: "Hace todo lo anterior y, además, elimina las preferencias y mueve Eleven Views Tools a la Papelera, sin dejar rastro. La app se cierra al terminar. Puedes reinstalarla cuando quieras.",
        advancedUninstallButton: "Desinstalar Eleven Views Tools por completo",
        advancedUninstallConfirmTitle: "¿Desinstalar Eleven Views Tools?",
        advancedUninstallConfirmBody: "Eleven Views Tools borrará sus permisos, eliminará sus preferencias y se moverá a la Papelera; después se cerrará. Esto no se puede deshacer desde la app, pero permanece en la Papelera hasta que la vacíes.",
        ...
        keepAwakeAutoStart: "Mantener activo al abrir Eleven Views Tools",
        ...
        switcherEnable: "Usar el selector de Eleven Views Tools",
        ...
        uninstallerFDAHint: "Activa Eleven Views Tools en la lista. Si no aparece, haz clic en + y elige Eleven Views Tools en Aplicaciones. El acceso solo se aplica después de volver a abrir la app.",
        ...
        homebrewMissingBody: "Eleven Views Tools puede abrir Terminal con el instalador oficial de Homebrew. Terminal muestra los pasos y pide tu contraseña si hace falta.",
        ...
        homebrewShellSetupBody: "Homebrew está instalado, pero Terminal quizá aún no encuentre el comando brew. Eleven Views Tools puede abrir Terminal con el comando de configuración.",
        ...
        homebrewTerminalFallback: "Esta operación necesita Terminal para pedir la contraseña de administrador. Eleven Views Tools no captura contraseñas.",
        ...
        updateNotifyTitle: "Actualización de Eleven Views Tools",
        ...
        updateNeedsApplicationsTitle: "Mueve Eleven Views Tools a Aplicaciones",
        updateNeedsApplicationsBody: "La app se está ejecutando desde un lugar que no se puede actualizar, como la imagen de disco o una ubicación temporal del sistema. Arrastra Eleven Views Tools a la carpeta Aplicaciones, ábrela desde ahí y vuelve a intentarlo.",
        ...
        obStart: "Abrir Eleven Views Tools",
        obStepWelcomeTitle: "Te damos la bienvenida a Eleven Views Tools",
        ...
        obStepDoneBody: "Eleven Views Tools ya está cuidando de tu Mac.",
        ...
        obLanguageUpdateBody: "Eleven Views Tools ahora habla varios idiomas. Elige el que quieras usar; puedes cambiarlo cuando quieras en Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear el teclado de forma segura, Eleven Views Tools necesita el permiso de Accesibilidad. Concédelo en Ajustes del Sistema e inténtalo de nuevo.",
        ...
        donateHeading: "Ayuda a que Eleven Views Tools siga creciendo",
        donateMessage: "Eleven Views Tools es gratis, independiente y lo desarrollo en mi tiempo libre. Si quieres contribuir económicamente, Buy Me a Coffee ayuda directamente a mantener el desarrollo en marcha.",
        donateButton: "Apoyar en Buy Me a Coffee",
        donateThanks: "Gracias por estar aquí. 🖤",
        supportIntroTitle: "Ayuda a que Eleven Views Tools siga creciendo",
        supportIntroMessage: "Si quieres apoyar económicamente el desarrollo, Buy Me a Coffee es el único lugar para hacerlo.",
        supportIntroStarButton: "Dar una estrella a Eleven Views Tools en GitHub",
        supportIntroStarMessage: "Nunca se espera apoyo económico. Una estrella en GitHub ayuda a que más personas descubran Eleven Views Tools y marca una diferencia real en su desarrollo.",
        supportIntroCoffeeButton: "Apoyar en Buy Me a Coffee",
        supportIntroLaterButton: "Ahora no",
        supportIntroDoneButton: "Listo",
        discordIntroTitle: "La comunidad de Eleven Views Tools en Discord acaba de empezar",
        discordIntroMessage: "La comunidad de Eleven Views Tools es nueva y todavía está tomando forma. Únete desde el principio para conocer a otros usuarios y ayudar a crear un espacio acogedor alrededor de la app.",
        ...
        communityIntroFollowButton: "Seguir a Eleven Views en X",
        homebrewOfficialIntroTitle: "Ahora en el catálogo oficial de Homebrew",
        homebrewOfficialIntroMessage: "Eleven Views Tools ya se puede instalar directamente desde el catálogo oficial de Homebrew.",
        ...
        showMenuBarIconCaption: "Si el icono de Eleven Views Tools desaparece (macOS puede ocultar iconos de la barra de menús cuando se queda sin espacio, algo habitual en Macs con notch), vuelve a abrir Eleven Views Tools desde Aplicaciones o Spotlight: eso recrea el icono y, si sigue oculto, abre esta ventana. El botón de arriba hace lo mismo cuando ya puedes llegar hasta aquí. Mantener menos iconos en la barra de menús, o menos métricas en Eleven Views Tools, lo hace mucho menos probable.",
        ...
        menuBarIconManagerHintFormat: "%@ está abierto y puede estar guardando el icono en su sección oculta. Busca Eleven Views Tools ahí, o configura %@ para mostrar siempre Eleven Views Tools.",
        ...
        cleanerNotifDenied: "Las notificaciones de Eleven Views Tools están desactivadas en el sistema.",
        cleanerNotifOpenSettings: "Abrir ajustes de notificaciones…",
        launchAtLoginNeedsApplications: "La app se está ejecutando desde un lugar que no permite abrirse al iniciar sesión. Arrastra Eleven Views Tools a la carpeta Aplicaciones, ábrelo desde ahí y actívalo de nuevo.",
