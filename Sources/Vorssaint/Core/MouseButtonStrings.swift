...
extension MouseButtonFeatureStrings {
    static let enUS = MouseButtonFeatureStrings(
        ...
        captureBlind: "Eleven Views Tools cannot watch the mouse right now.",
    ...
    static let ptBR = MouseButtonFeatureStrings(
        ...
        captureBlind: "O Eleven Views Tools não consegue observar o mouse agora.",
    ...
    static let tr = MouseButtonFeatureStrings(
        ...
        captureBlind: "Eleven Views Tools şu anda fareyi izleyemiyor.",
    ...
    static let ru = MouseButtonFeatureStrings(
        ...
        captureBlind: "Eleven Views Tools сейчас не может отслеживать мышь.",
    ...
    static let es = MouseButtonFeatureStrings(
        ...
        captureCancel: "Cancelar",
        captureBlind: "Eleven Views Tools no puede observar el ratón ahora mismo.",
    ...
    static let de = MouseButtonFeatureStrings(
        ...
        captureBlind: "Eleven Views Tools kann die Maus gerade nicht beobachten.",
    ...
    static let fr = MouseButtonFeatureStrings(
        ...
        captureBlind: "Eleven Views Tools ne peut pas observer la souris pour le moment.",
    ...
    static let it = MouseButtonFeatureStrings(
        ...
        captureBlind: "Eleven Views Tools al momento non riesce a osservare il mouse.",
    ...
    static let ja = MouseButtonFeatureStrings(
        ...
        captureCancel: "キャンセル",
        captureBlind: "Eleven Views Toolsは今マウスを監視できません。",
    ...
    static let ko = MouseButtonFeatureStrings(
        ...
        captureCancel: "취소",
        captureBlind: "Eleven Views Tools가 지금은 마우스를 지켜볼 수 없습니다.",
    ...
    static let zhHans = MouseButtonFeatureStrings(
        ...
        captureCancel: "取消",
        captureBlind: "Eleven Views Tools 目前无法监视鼠标。",
    ...
    static let zhTW = MouseButtonFeatureStrings(
        ...
        captureCancel: "取消",
        captureBlind: "Eleven Views Tools 目前無法監看滑鼠。",
