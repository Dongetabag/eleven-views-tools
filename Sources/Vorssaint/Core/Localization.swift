...
extension Strings {
    static let ptBR = Strings(
        statusIdleTooltip: "Eleven Views Tools: suspensão normal",
        statusActiveUntil: "Eleven Views Tools: ativo até",
        statusActiveIndefinite: "Eleven Views Tools: ativo indefinidamente",
        menuEnableAwake: "Ativar manter acordado",
        menuDisableAwake: "Desativar manter acordado",
        menuActivateFor: "Ativar por…",
        menuSettings: "Ajustes…",
        menuAbout: "Sobre o Eleven Views Tools",
        menuQuit: "Sair do Eleven Views Tools",
        menuHide: "Ocultar o Eleven Views Tools",
        ...
        keepAwakeActiveIconVorssaint: "Eleven Views Tools",
        ...
        notifyBatteryTitle: "Eleven Views Tools desativado",
        notifyBatteryBody: "Bateria baixa. A suspensão normal foi restaurada para proteger a carga.",
        adminPromptClamshellOn: "O Eleven Views Tools precisa da sua senha para manter o Mac ativo com a tampa fechada.",
        adminPromptClamshellOff: "O Eleven Views Tools precisa da sua senha para reativar a suspensão normal do Mac.",
        adminPromptRecover: "O Eleven Views Tools foi encerrado com a suspensão do Mac desativada. Digite a senha para restaurar a suspensão normal.",
        adminPromptUpdate: "O Eleven Views Tools precisa da sua senha para instalar a atualização.",
        adminPromptSudoersInstall: "O Eleven Views Tools vai criar uma regra restrita (somente pmset disablesleep) para alternar a tampa fechada sem pedir senha. Esta é a única vez que a senha será necessária.",
        adminPromptSudoersRemove: "O Eleven Views Tools vai remover a regra de tampa fechada sem senha.",

        settingsTitle: "Ajustes do Eleven Views Tools",
        tabGeneral: "Geral",
        tabEnergy: "Energia",
        ...
        advancedResetDescription: "Remove todas as permissões que você concedeu ao Eleven Views Tools (Acessibilidade, Gravação de Tela, Acesso Total ao Disco e outras), o item de início e a regra de tampa fechada. Útil para começar do zero ou antes de desinstalar. O app continua instalado.",
        ...
        advancedUninstallDescription: "Faz tudo acima e ainda apaga as preferências e move o Eleven Views Tools para a Lixeira, sem deixar rastro no sistema. O app fecha ao final. Você pode reinstalar quando quiser.",
        advancedUninstallButton: "Desinstalar o Eleven Views Tools completamente",
        advancedUninstallConfirmTitle: "Desinstalar o Eleven Views Tools?",
        advancedUninstallConfirmBody: "O Eleven Views Tools vai limpar as permissões, apagar as preferências e ir para a Lixeira, e então fechar. Esta ação não pode ser desfeita pelo app, mas ele fica na Lixeira até você esvaziá-la.",
        ...
        keepAwakeAutoStart: "Manter acordado ao abrir o Eleven Views Tools",
        ...
        switcherEnable: "Usar o alternador do Eleven Views Tools",
        ...
        uninstallerFDAHint: "Ative o Eleven Views Tools na lista. Se ele não aparecer, clique no + e escolha o Eleven Views Tools em Aplicativos. O acesso só vale depois de reabrir o app.",
        ...
        homebrewMissingBody: "O Eleven Views Tools pode abrir o Terminal com o instalador oficial do Homebrew. O Terminal mostra os passos e pede sua senha se precisar.",
        ...
        homebrewShellSetupBody: "O Homebrew está instalado, mas o Terminal ainda pode não encontrar o comando brew. O Eleven Views Tools pode abrir o Terminal com o comando de configuração.",
        ...
        homebrewTerminalFallback: "Esta operação precisa do Terminal para pedir a senha de administrador. O Eleven Views Tools não captura senhas.",
        ...
        updateNotifyTitle: "Atualização do Eleven Views Tools",
        ...
        updateNeedsApplicationsTitle: "Mova o Eleven Views Tools para Aplicativos",
        updateNeedsApplicationsBody: "O app está rodando de um lugar que não dá para atualizar, como a imagem de disco ou uma área temporária do sistema. Arraste o Eleven Views Tools para a pasta Aplicativos, abra de lá e tente de novo.",
        ...
        obStart: "Abrir o Eleven Views Tools",
        obStepWelcomeTitle: "Bem-vindo ao Eleven Views Tools",
        ...
        obStepDoneBody: "O Eleven Views Tools já está cuidando do seu Mac.",
        ...
        obLanguageUpdateBody: "O Eleven Views Tools agora fala vários idiomas. Escolha o que você prefere usar; dá para mudar quando quiser nos Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear o teclado com segurança, o Eleven Views Tools precisa da permissão de Acessibilidade. Conceda em Ajustes do Sistema e tente de novo.",
        ...
        donateHeading: "Ajude o Eleven Views Tools a continuar crescendo",
        donateMessage: "O Eleven Views Tools é gratuito, independente e desenvolvido no meu tempo livre. Se você quiser contribuir financeiramente, o Buy Me a Coffee ajuda diretamente a manter o desenvolvimento avançando.",
        donateButton: "Apoiar no Buy Me a Coffee",
        donateThanks: "Obrigado por estar aqui. 🖤",
        supportIntroTitle: "Ajude o Eleven Views Tools a continuar crescendo",
        ...
        supportIntroStarMessage: "Apoio financeiro nunca é esperado. Dar uma estrela no GitHub ajuda mais pessoas a encontrar o Eleven Views Tools e faz uma diferença enorme no desenvolvimento.",
        supportIntroCoffeeButton: "Apoiar no Buy Me a Coffee",
        supportIntroLaterButton: "Agora não",
        supportIntroDoneButton: "Concluir",
        discordIntroTitle: "A comunidade do Eleven Views Tools no Discord está começando",
        discordIntroMessage: "A comunidade do Eleven Views Tools é nova e ainda está em desenvolvimento. Entre desde o começo para conhecer outros usuários e ajudar a construir um espaço acolhedor em torno do app.",
        ...
        communityIntroFollowButton: "Seguir Eleven Views no X",
        homebrewOfficialIntroTitle: "Agora no catálogo oficial do Homebrew",
        homebrewOfficialIntroMessage: "O Eleven Views Tools agora pode ser instalado direto do catálogo oficial do Homebrew.",
        ...
        showMenuBarIconCaption: "Se o ícone do Eleven Views Tools sumir (o macOS pode esconder ícones quando a barra de menus fica sem espaço, comum em Macs com notch), reabra o Eleven Views Tools pela pasta Aplicativos ou pelo Spotlight: isso recria o ícone e, se ele ainda estiver escondido, abre esta janela. O botão acima faz o mesmo quando você já consegue chegar aqui. Manter menos ícones na barra, ou menos métricas no Eleven Views Tools, reduz bastante a chance.",
        ...
        menuBarIconManagerHintFormat: "O %@ está aberto e pode estar guardando o ícone na seção oculta dele. Procure o Eleven Views Tools lá, ou configure o %@ para sempre mostrar o Eleven Views Tools.",
        ...
        cleanerNotifDenied: "As notificações do Eleven Views Tools estão desativadas no sistema.",
        cleanerNotifOpenSettings: "Abrir Ajustes de Notificações…",
        launchAtLoginNeedsApplications: "O app está rodando de um lugar que não permite abrir no login. Arraste o Eleven Views Tools para a pasta Aplicativos, abra de lá e ligue de novo.",
...
extension Strings {
    static let enUS = Strings(
        statusIdleTooltip: "Eleven Views Tools: normal sleep",
        statusActiveUntil: "Eleven Views Tools: awake until",
        statusActiveIndefinite: "Eleven Views Tools: awake indefinitely",
        menuEnableAwake: "Enable keep awake",
        menuDisableAwake: "Disable keep awake",
        menuActivateFor: "Activate for…",
        menuSettings: "Settings…",
        menuAbout: "About Eleven Views Tools",
        menuQuit: "Quit Eleven Views Tools",
        menuHide: "Hide Eleven Views Tools",
        ...
        notifyBatteryTitle: "Eleven Views Tools disabled",
        notifyBatteryBody: "Low battery. Normal sleep was restored to protect the charge.",
        adminPromptClamshellOn: "Eleven Views Tools needs your password to keep the Mac going with the lid closed.",
        adminPromptClamshellOff: "Eleven Views Tools needs your password to restore the Mac's normal sleep.",
        adminPromptRecover: "Eleven Views Tools quit while the Mac's sleep was disabled. Enter the password to restore normal sleep.",
        adminPromptUpdate: "Eleven Views Tools needs your password to install the update.",
        adminPromptSudoersInstall: "Eleven Views Tools will create a restricted rule (pmset disablesleep only) to toggle closed-lid mode without asking for a password. This is the only time the password is needed.",
        adminPromptSudoersRemove: "Eleven Views Tools will remove the password-free closed-lid rule.",

        settingsTitle: "Eleven Views Tools Settings",
        tabGeneral: "General",
        tabEnergy: "Energy",
        ...
        advancedResetDescription: "Removes every permission you granted Eleven Views Tools (Accessibility, Screen Recording, Full Disk Access and others), the login item and the closed-lid rule. Useful to start fresh or before uninstalling. The app stays installed.",
        ...
        advancedUninstallDescription: "Does all of the above, then removes the preferences and moves Eleven Views Tools to the Trash, leaving nothing behind. The app quits when done. You can reinstall anytime.",
        advancedUninstallButton: "Uninstall Eleven Views Tools completely",
        advancedUninstallConfirmTitle: "Uninstall Eleven Views Tools?",
        advancedUninstallConfirmBody: "Eleven Views Tools will clear its permissions, remove its preferences and move to the Trash, then quit. This can't be undone from the app, but it stays in the Trash until you empty it.",
        ...
        keepAwakeAutoStart: "Keep Awake when Eleven Views Tools opens",
        ...
        switcherEnable: "Use the Eleven Views Tools switcher",
        ...
        uninstallerFDAHint: "Turn Eleven Views Tools on in the list. If it isn't there, click + and pick Eleven Views Tools from Applications. Access only applies after you reopen the app.",
        ...
        homebrewMissingBody: "Eleven Views Tools can open Terminal with the official Homebrew installer. Terminal shows the steps and asks for your password if needed.",
        ...
        homebrewShellSetupBody: "Homebrew is installed, but Terminal may not find the brew command yet. Eleven Views Tools can open Terminal with the setup command.",
        ...
        homebrewTerminalFallback: "This operation needs Terminal to ask for the administrator password. Eleven Views Tools does not capture passwords.",
        ...
        updateNotifyTitle: "Eleven Views Tools update",
        ...
        updateNeedsApplicationsTitle: "Move Eleven Views Tools to Applications",
        updateNeedsApplicationsBody: "The app is running from a place that cannot be updated, such as the disk image or a temporary system location. Drag Eleven Views Tools to the Applications folder, open it from there and try again.",
        ...
        obStart: "Open Eleven Views Tools",
        obStepWelcomeTitle: "Welcome to Eleven Views Tools",
        ...
        obStepDoneBody: "Eleven Views Tools is already looking after your Mac.",
        ...
        obLanguageUpdateBody: "Eleven Views Tools now speaks several languages. Choose the one you’d like to use; you can change it anytime in Settings.",
        ...
        cleaningNeedsAxBody: "To lock the keyboard safely, Eleven Views Tools needs Accessibility permission. Grant it in System Settings and try again.",
        ...
        donateHeading: "Help Eleven Views Tools keep growing",
        donateMessage: "Eleven Views Tools is free, independent and built in my spare time. If you would like to contribute financially, Buy Me a Coffee directly helps me keep development moving forward.",
        donateButton: "Support on Buy Me a Coffee",
        donateThanks: "Thank you for being here. 🖤",
        supportIntroTitle: "Help Eleven Views Tools keep growing",
        supportIntroMessage: "If you would like to support development financially, Buy Me a Coffee is the one place to do it.",
        supportIntroStarButton: "Star Eleven Views Tools on GitHub",
        supportIntroStarMessage: "Financial support is never expected. A star on GitHub helps more people discover Eleven Views Tools and makes a real difference to its development.",
        supportIntroCoffeeButton: "Support on Buy Me a Coffee",
        supportIntroLaterButton: "Not now",
        supportIntroDoneButton: "Done",
        discordIntroTitle: "The Eleven Views Tools Discord community is just getting started",
        discordIntroMessage: "The Eleven Views Tools community is new and still being built. Join early to meet other users and help build a welcoming space around the app.",
        ...
        communityIntroFollowButton: "Follow Eleven Views on X",
        homebrewOfficialIntroTitle: "Now in the official Homebrew catalog",
        homebrewOfficialIntroMessage: "Eleven Views Tools can now be installed directly from the official Homebrew catalog.",
        ...
        showMenuBarIconCaption: "If Eleven Views Tools's icon disappears (macOS can hide menu bar icons when the bar runs out of room, common on Macs with a notch), reopen Eleven Views Tools from Applications or Spotlight: that rebuilds the icon and, if it's still hidden, opens this window. The button above does the same when you can already get here. Keeping fewer menu bar icons, or fewer Eleven Views Tools metrics, makes it far less likely.",
        ...
        menuBarIconManagerHintFormat: "%@ is open and may be keeping the icon in its hidden section. Look for Eleven Views Tools there, or set %@ to always show Eleven Views Tools.",
        ...
        cleanerNotifDenied: "Eleven Views Tools notifications are turned off in the system.",
        cleanerNotifOpenSettings: "Open Notification Settings…",
        launchAtLoginNeedsApplications: "The app is running from a place that cannot open at login. Drag Eleven Views Tools to the Applications folder, open it from there and turn this on again.",
