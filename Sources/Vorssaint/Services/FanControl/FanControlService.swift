...
final class FanControlService: ObservableObject {
    ...
    private let probeQueue = DispatchQueue(label: "io.elevenviews.tools.fan-control.probe",
                                           qos: .utility)
    ...
    private static var helperVersion: String {
        Bundle.main.object(forInfoDictionaryKey: "EVToolsFanControlHelperVersion") as? String
