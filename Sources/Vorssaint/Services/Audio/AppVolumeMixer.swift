...
final class AppVolumeMixer: ObservableObject {
    ...
    private let buildQueue = DispatchQueue(label: "io.elevenviews.tools.mixer", qos: .userInitiated)
    ...
    private let halQueue = DispatchQueue(label: "io.elevenviews.tools.mixer.hal", qos: .userInitiated)
...
private final class TapGainEngine: GainEngine {
    ...
    init?(objects: [AudioObjectID], gain: Float, outputDeviceUID: String) {
        ...
        let aggregate: [String: Any] = [
            kAudioAggregateDeviceNameKey: "Eleven Views Tools Mixer",
    ...
    private static let rateQueue = DispatchQueue(label: "io.elevenviews.tools.mixer.rate",
                                                 qos: .userInitiated)
    ...
    private static let teardownQueue = DispatchQueue(label: "io.elevenviews.tools.mixer.teardown",
                                                     qos: .utility)
